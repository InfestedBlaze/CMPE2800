...
public class Connection
{
    ...
    public delegate void delVoidConnectionString(Connection i, string x);
    public delegate void delVoidLineSegment(LineSegment i);

    private Socket connection = null;
    private delVoidConnectionString Disconnect = null;
    ...
    public System.Net.EndPoint address { get; }
    public uint framesRx { get; private set; } = 0;
    public uint fragments { get; private set; } = 0;
    public uint receiveEvents { get; private set; } = 0;
    public uint bytesRx { get; private set; } = 0;
    ...
    private void ThreadReading()
    {
        ...
        while (true)
        {
            ...
            catch (Exception err)
            {
                ...
                Disconnect(this, "Hard Disconnect: " + err.Message);
                return;
            }
            ...
            {
                //Invoke handle loss of connection
                Disconnect(this, "Soft Disconnect");
                return;
            }
